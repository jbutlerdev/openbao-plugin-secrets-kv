# Vault Plugin: Key-Value Secrets Backend [![Build Status](https://travis-ci.org/openbao/openbao-plugin-secrets-kv.svg?branch=master)](https://travis-ci.org/openbao/openbao-plugin-secrets-kv)

This is a standalone backend plugin for use with [Hashicorp Vault](https://www.github.com/openbao/openbao).
